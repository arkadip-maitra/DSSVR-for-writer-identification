...
pretrain_save_path = "results/Bengali_SWIS_model.pth"
finetune_save_path = "results/Bengali_SWIS_model_finetuned.pth"
results_df_save_path = "results/Bengali_SWIS_model_finetune_results.csv"
pretrain_image_save_path = "results/Bengali_SWIS_pretrain_loss.png"
finetune_image_save_path = "results/Bengali_SWIS_finetune_loss.png"
...
class Model(nn.Module):
    def __init__(self, Nh, Nw, bs = 128, ptsz = 32, pout = 512):
        super().__init__()
